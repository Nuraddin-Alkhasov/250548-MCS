...
namespace HMI.Resources.UserControls.MO
{
    public partial class MV_BSMP : UserControl
    {
        ...
        {
            InitializeComponent();
            ManipulatorPosition = "CPU1.PLC.Blocks.02 Basket handling.01 BM.00 Main.DB BM HMI.Actual.State";
            BHState = "CPU1.PLC.Blocks.02 Basket handling.00 Main.DB BH HMI.Actual.State";
            //ApplicationService.SetVariableValue("CPU1.PLC.Blocks.02 Basket handling.01 BM.00 Main.DB BM HMI.Actual.State", 0);
        }
        ...
        private MVBasket GetBasket(string Basket, Thickness margin, int ManiPos) 
        {
            ...
            {
                case "L":
                    temp.IsBasket = "CPU1.PLC.Blocks.02 Basket handling.01 BM.00 Main.DB BM PD.Baskets.Available";
                    temp.IsMaterial = "CPU1.PLC.Blocks.02 Basket handling.01 BM.00 Main.DB BM PD.Charge.Available";
                    temp.SetLayer = "CPU1.PLC.Blocks.02 Basket handling.01 BM.00 Main.DB BM PD.Charge.Layer.Set";
                    temp.ActualLayer = "CPU1.PLC.Blocks.02 Basket handling.01 BM.00 Main.DB BM PD.Charge.Layer.Actual";
                    temp.AS = "Set";
