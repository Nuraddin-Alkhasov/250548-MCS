    ...
    public partial class MV_CZ : UserControl
    {
        ...
        private MVTray GetCZTray(int i)
        {
            if (i >= 0 && i <= 1) 
            {
                return new MVTray()
                {
                    IsTray = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].PD.Tray.Available",
                    IsMaterial = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].PD.Charge.Available",
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].PD.Charge.Layer.Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].PD.Charge.Layer.Actual",
                    IsDischarge = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].PD.Tray.Functions.Discharge",
                    IsWatch = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].PD.Tray.Functions.Watch",
                    Station = 15,
                    Place = i,
                    Type = "Tray",
                    CPU = "CPU2",
            ...
            if (i >= 2 && i <= 3)
            {
                return new MVTray()
                {
                    IsTray = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].PD.Tray.Available",
                    IsMaterial = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].PD.Charge.Available",
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].PD.Charge.Layer.Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].PD.Charge.Layer.Actual",
                    IsDischarge = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].PD.Tray.Functions.Discharge",
                    IsWatch = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].PD.Tray.Functions.Watch",
                    Station = 16,
                    Place = i-2,
                    Type = "Tray",
                    CPU = "CPU2",
            ...
            if (i >= 4 && i <= 5)
            {
                return new MVTray()
                {
                    IsTray = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].PD.Tray.Available",
                    IsMaterial = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].PD.Charge.Available",
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].PD.Charge.Layer.Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].PD.Charge.Layer.Actual",
                    IsDischarge = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].PD.Tray.Functions.Discharge",
                    IsWatch = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].PD.Tray.Functions.Watch",
                    Station = 17,
                    Place = i-4,
                    Type = "Tray",
                    CPU = "CPU2",
            ...
            if (i >= 6 && i <= 7)
            {
                return new MVTray()
                {
                    IsTray = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].PD.Tray.Available",
                    IsMaterial = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].PD.Charge.Available",
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].PD.Charge.Layer.Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].PD.Charge.Layer.Actual",
                    IsDischarge = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].PD.Tray.Functions.Discharge",
                    IsWatch = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].PD.Tray.Functions.Watch",
                    Station = 18,
                    Place = i-6,
                    Type = "Tray",
                    CPU = "CPU2",
