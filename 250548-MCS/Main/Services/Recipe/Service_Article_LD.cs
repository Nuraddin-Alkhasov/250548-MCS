            ...
            if ((bool)e.Value)
            {
                Task obTask = Task.Run(async () =>
                {
                    ...
                    try
                    {
                        ...
                        ApplicationService.SetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD PD.Charge.Layer.Set", counter);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        File.WriteAllText("C:\\Backup\\VW_LD_" + DateTime.Now.ToString("yyyy_MM_dd_HH_mm_ss") + ".txt", Message);
                    }
                });
            }
