...
namespace HMI.Services
{
    ...
    class Service_Protocol : ServiceBase, IProtocol
    {
        ...
        protected override void OnLoadProjectCompleted()
        {
            ...
            {
                Machine = Machine,
                Data_1 = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Customer.from.Data1#STRING20"),
                Data_2 = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Customer.from.Data2#STRING20"),
                Data_3 = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Customer.from.Data3#STRING20"),
            ...
            {
                Machine = Machine,
                Box_Id = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.04 BS.00 Main.DB BS PD.Header.Box"),
                Charge_Id = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.04 BS.00 Main.DB BS PD.Header.Charge"),             
                Layer_Id = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.04 BS.00 Main.DB BS PD.Header.Layer"),
                ...
                RMO = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.04 BS.00 Main.DB BS PD.Charge.RMO")
            };
                ...
                "CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.Protocol.to.Coating.Alarm")
            {
                ...
                ActualLayer= VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD PD.Charge.Layer.Actual"),
            ...
            {
                HZ = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.00 Main.DB HZ HMI.Parameter.Stack[19].Id"),
                Place = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.00 Main.DB HZ HMI.Parameter.Stack[19].Place"),
                HZ1_Layer_Id = new List<IVariable>()
                {
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[0].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[1].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[2].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[3].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[4].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[5].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[6].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[7].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[8].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.01.00 Main.DB HZ 1 PD.Place[9].PD.Header.Layer"),
                },
                HZ2_Layer_Id = new List<IVariable>()
                {
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[0].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[1].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[2].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[3].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[4].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[5].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[6].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[7].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[8].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.06 HZ.02.00 Main.DB HZ 2 PD.Place[9].PD.Header.Layer"),
                },
                ...
                "CPU2.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.Protocol.to.Cooling.Alarm")
            {
                ...
                {
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[0].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[1].PD.Header.Layer"),
                },
                CZ2_Layer_Id = new List<IVariable>()
                {
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[0].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[1].PD.Header.Layer"),
                },
                CZ3_Layer_Id = new List<IVariable>()
                {
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[0].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[1].PD.Header.Layer"),
                },
                CZ4_Layer_Id = new List<IVariable>()
                {
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[0].PD.Header.Layer"),
                    VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[1].PD.Header.Layer"),
                },
                TM_Layer_Id = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.04 TM.00 Main.DB TM PD.Header.Layer"),
            ...
            {
                Layer_Id = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.09 US.01.00 Main.DB US 1 PD.Belt.Header.Layer"),
                Order_US = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.09 US.01.00 Main.DB US 1 HMI.Actual.Order#STRING20")
            };

            discharging2 = new Discharging("CPU2.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.Protocol.to.Discharging 2")
            {
                Layer_Id = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.09 US.02.00 Main.DB US 2 PD.Belt.Header.Layer"),
                Order_US = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.09 US.02.00 Main.DB US 2 HMI.Actual.Order#STRING20")
            };
