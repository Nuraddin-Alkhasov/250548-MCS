    ...
    public partial class MO_PZWZ
    {
        ...
        private PZWZTray GetPZWZTray(int i, bool head)
        {
            return new PZWZTray()
            {
                ...
                SetLayer = "CPU2.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Layer.Set",
                ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Layer.Actual",
