...
namespace HMI.MainRegion.MO
{
    ...
    public partial class MO_CZ
    {
        ...
        private void LanguageService_LanguageChanged(object sender, LanguageChangedEventArgs e)
        {
            ...
            switch (languageService.CurrentLanguage.LCID)
            {
                case 1033:
                    ...
                    CZ1L2.EndValue = CZ2L2.EndValue = CZ3L2.EndValue = CZ4L2.EndValue = 95;
                    CZ1L3.StartValue = CZ2L3.StartValue = CZ1L3.StartValue = CZ4L3.StartValue = 95;
                    CZ1L3.EndValue = CZ2L3.EndValue = CZ3L3.EndValue = CZ4L3.EndValue = 122;
                    break;
                ...
                default:
                    ...
                    CZ1L2.EndValue = CZ2L2.EndValue = CZ3L2.EndValue = CZ4L2.EndValue = 35;
                    CZ1L3.StartValue = CZ2L3.StartValue = CZ1L3.StartValue = CZ4L3.StartValue = 35;
                    CZ1L3.EndValue = CZ2L3.EndValue = CZ3L3.EndValue = CZ4L3.EndValue = 50;
        ...
        private CZTray GetCZTray(int i, bool head, byte cz)
        {
            return new CZTray()
            {
                IsTray = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Tray.Available",
                IsMaterial = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Charge.Available",
                SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Charge.Layer.Set",
                ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Charge.Layer.Actual",
                IsDischarge = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Tray.Functions.Discharge",
                IsWatch = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Tray.Functions.Watch",
                Charge = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].PD.Header.Charge",
