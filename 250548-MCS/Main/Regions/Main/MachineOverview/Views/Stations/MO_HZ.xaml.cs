...
namespace HMI.MainRegion.MO.Views
{
    ...
    public partial class MO_HZ
    {
                ...
                if (i <= 9)
                {
                    ...
                    if (i == 0 || i == 3 || i == 4 || i == 7 || i == 8)
                    {
                        Dispatcher.InvokeAsync(delegate
                        {
                            ...
                            switch (i)
                            {
                                case 0: T1.Margin = new Thickness(433, 0, 0, 63); break;
                                case 3: T1.Margin = new Thickness(433, 0, 0, 144); break;
                                case 4: T1.Margin = new Thickness(433, 0, 0, 225); break;
                                case 7: T1.Margin = new Thickness(433, 0, 0, 306); break;
                                case 8: T1.Margin = new Thickness(433, 0, 0, 387); break;
                            }
                    ...
                    else
                    {
                        Dispatcher.InvokeAsync(delegate
                        {
                            ...
                            switch (i)
                            {
                                case 1: T2.Margin = new Thickness(597, 0, 0, 63); break;
                                case 2: T2.Margin = new Thickness(597, 0, 0, 144); break;
                                case 5: T2.Margin = new Thickness(597, 0, 0, 225); break;
                                case 6: T2.Margin = new Thickness(597, 0, 0, 306); break;
                                case 9: T2.Margin = new Thickness(597, 0, 0, 387); break;
                            }
        ...
        private void LanguageService_LanguageChanged(object sender, LanguageChangedEventArgs e)
        {
            ...
            switch (languageService.CurrentLanguage.LCID)
            {
                case 1033:
                    ...
                    HZ1L1.StartValue = HZ2L1.StartValue = 32;
                    HZ1L1.EndValue = HZ2L1.EndValue = 608;
                    HZ1L2.StartValue = HZ2L2.StartValue = 608;
                    HZ1L2.EndValue = HZ2L2.EndValue = 635;
                    HZ1L3.StartValue = HZ2L3.StartValue = 635;
                    HZ1L3.EndValue = HZ2L3.EndValue = 662;
                    break;
                ...
                default:
                    ...
                    HZ1L1.StartValue = HZ2L1.StartValue = 0;
                    HZ1L1.EndValue = HZ2L1.EndValue = 320;
                    HZ1L2.StartValue = HZ2L2.StartValue = 320;
                    HZ1L2.EndValue = HZ2L2.EndValue = 335;
                    HZ1L3.StartValue = HZ2L3.StartValue = 335;
                    HZ1L3.EndValue = HZ2L3.EndValue = 350;
                    break;
            }
        }
        private HZTray_L GetHZTray_L(int i, bool head, byte hz)
        {
            return new HZTray_L()
            {
                IsTray = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Tray.Available", 
                IsMaterial = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Charge.Available",
                SetLayer = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Charge.Layer.Set",
                ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Charge.Layer.Actual",
                IsDischarge = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Tray.Functions.Discharge",
                IsWatch = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Tray.Functions.Watch",
                Charge = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].PD.Header.Charge",
                Station = hz == 1 ? 13 : 14,
                Place = i,
                Head = head,
                Type = "Tray",
