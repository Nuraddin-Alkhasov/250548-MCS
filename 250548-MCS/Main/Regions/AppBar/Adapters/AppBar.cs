...
namespace HMI.AppBarRegion.Adapters
{
    ...
    public class AppBar : AdapterBase
    {
        ...
        private void ChangeLanguageExecuted(object parameter)
        {
            switch (languageService.CurrentLanguage.LCID)
            {
                case 3081: languageService.ChangeLanguageAsync(1031); break;
                case 1031: languageService.ChangeLanguageAsync(2058); break;
                case 2058: languageService.ChangeLanguageAsync(1033); break;
                case 1033: languageService.ChangeLanguageAsync(3081); break;
            }
        }
