...
namespace HMI.DialogRegion.MO.Adapters
{
    ...
    public class MO_Status_2 : AdapterBase
    {
        ...
        {
            ApplicationService.SetView("DialogRegion2", "Recipe_Selector", "MO_Status_2");
        }
        #endregion
...
;                switch (SPData.Type)
        ...
        public void SetData(int _mrId) 
        {
            ...
            if (_mrId > 0)
            {
                ...
                byte actualLayer = (byte)ApplicationService.GetVariableValue("CPU2.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer.Actual");
                ...
                ApplicationService.SetVariableValue("CPU2.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer.Set", counter);
